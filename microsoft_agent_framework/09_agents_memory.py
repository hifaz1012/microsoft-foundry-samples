...
async def main() -> None:
    ...
    async with AzureCliCredential() as credential:
        ...
        async with AzureAIClient(credential=credential).as_agent(
            name="MyMemoryAgent",
        ...
        # Clean up - delete the agent and memory store
        async with AIProjectClient(endpoint=endpoint, credential=credential) as project_client:
            await project_client.memory_stores.delete(memory_store_name)
            await project_client.agents.delete("MyMemoryAgent")
            print("Memory store and Agent deleted")
